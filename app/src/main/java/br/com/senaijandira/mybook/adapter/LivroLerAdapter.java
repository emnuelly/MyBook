...
public class LivroLerAdapter extends ArrayAdapter<Livro>{
    ...
    public LivroLerAdapter(Context cont){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imgLido = v.findViewById(R.id.imgParaLer);
        ...
        imgRemover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(), "O livro foi removido de Quero Ler!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        imgLido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getContext(), "O livro foi adicionado a lidos", Toast.LENGTH_SHORT).show();
            }
        });
